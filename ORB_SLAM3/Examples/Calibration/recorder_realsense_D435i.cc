...
int main(int argc, char **argv) {
    ...
    rs2::config cfg;
    // Enable both infrared streams (left and right)
    cfg.enable_stream(RS2_STREAM_INFRARED, 1, 1280, 800, RS2_FORMAT_Y8, 15);
    cfg.enable_stream(RS2_STREAM_INFRARED, 2, 1280, 800, RS2_FORMAT_Y8, 15);
    ...
    auto imu_callback = [&](const rs2::frame& frame)
    {
        ...
        {
            rs2::video_frame color_frame_left = fs.get_infrared_frame(1);
            rs2::video_frame color_frame_right = fs.get_infrared_frame(2);
    ...
    rs2::stream_profile cam_stream_left = pipe_profile.get_stream(RS2_STREAM_INFRARED, 1);
    rs2::stream_profile cam_stream_right = pipe_profile.get_stream(RS2_STREAM_INFRARED, 2);
    ...
    // if(!accFile.is_open() || !gyroFile.is_open() || !cam0TsFile.is_open() || !cam1TsFile.is_open()){
